...
namespace SWD392_RestaurantManagementSystem.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public RecipesController(RestaurantManagementContext context)
        {
            _context = context;
        }
        ...
        {
            var restaurantManagementContext = _context.Recipes.Include(r => r.MenuItem);
        ...
        public async Task<IActionResult> Create([Bind("RecipeId,MenuItemId,Instructions,CreatedAt")] Recipe recipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RecipeId,MenuItemId,Instructions,CreatedAt")] Recipe recipe)
        {
