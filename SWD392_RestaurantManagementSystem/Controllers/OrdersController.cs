...
namespace SWD392_RestaurantManagementSystem.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var restaurantManagementContext = _context.Orders.Include(o => o.Customer);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,OrderDate,Status,TotalAmount")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,OrderDate,Status,TotalAmount")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
