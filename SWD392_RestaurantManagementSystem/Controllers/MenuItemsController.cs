...
namespace SWD392_RestaurantManagementSystem.Controllers
{
    public class MenuItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MenuItemId,Name,Description,Price,Category,CreateDate")] MenuItem menuItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuItemId,Name,Description,Price,Category,CreateDate")] MenuItem menuItem)
        {
